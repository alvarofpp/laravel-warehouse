...
return [
    ...
    */
    ...
    'min_db' => 'O valor de :attribute deve ser no mínimo :min.',
    'trabalho_unico' => 'Só é possível marcar um tipo de trabalho como requerido!',
    'cnpj' => 'O :attribute informado é inválido.',
    'soma_carga_horaria' => 'Soma das cargas horárias deve ser igual à carga horária do componente.',
    'soma_carga_horaria_pratica' => 'Soma das cargas horárias de prática deve ser igual à carga horária do componente.',
    'soma_carga_horaria_estagio' => 'Soma das cargas horárias de estágio deve ser igual à carga horária do componente.',
    'separate' => 'Os valores de :attribute não podem se sobrepor.',
    'range' => 'O valor de :attribute deve ser um intervalo.',
    'date_range' => 'O campo deve ter o formato: dd/mm/yyyy - dd/mm/yyyy',
    ...
    */
    ...
    'custom' => [
        ...
        'instituicao_vinculada' => [
            'required_if' => 'O campo de :attribute é obrigatório quando o CNPJ não for próprio.',
        ],
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'frequencias.*.faltas' => 'faltas',
        'notas.*.nota' => 'nota',
        'carga_horaria' => 'carga horária',
        'descricao' => 'descrição',
        'instituicao_vinculada' => 'instituição vinculada',
        'alunos.*' => 'aluno',
